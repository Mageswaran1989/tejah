...
export SPARK_LOCAL_IP="101.63.183.221" #, to set the IP address Spark binds to on this node
...
export SPARK_MASTER_IP="101.63.183.221" #, to bind the master to a different IP address or hostname
...
# - SPARK_NICENESS      The scheduling priorityi for daemons. (Default: 0)
